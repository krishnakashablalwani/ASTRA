...
export default function Library() {
  ...
  const handleCheckout = async (e) => {
    ...
    try {
      ...
      alert(
        "Book checked out successfully! Return deadline added to student calendar."
      );
                  ...
                  >
                    <div className="card-body">
                      <h5 className="card-title">
                        Book Code: {checkout.bookCode}
                      </h5>
                      <p className="card-text text-muted">
                        {checkout.studentUser?.name || "Unknown"} (
                        {checkout.studentRollNo})
                      </p>
                      ...
                      {!checkout.returned && (
                        <>
                          <div
                            className={`alert ${
                              daysLeft < 3 ? "alert-danger" : "alert-info"
                            } mb-3`}
                          >
                            <small>
                              {daysLeft > 0
            ...
            <div key={book._id} className="col-md-6 col-lg-3 mb-4">
              ...
              >
                <div className="card-body">
                  ...
                  <p className="card-text text-muted mb-2">ISBN: {book.isbn}</p>
                  <p className="card-text mb-3">
                    <small className="text-muted">Code: {book.bookCode}</small>
                  </p>
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <span
                      className={`badge ${
                        book.availableQuantity > 0 ? "bg-success" : "bg-danger"
                      }`}
                    >
              ...
              <form onSubmit={handleEditBook}>
                <div className="modal-body">
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <small className="text-muted">
                      Currently {editingBook.availableQuantity} available out of{" "}
