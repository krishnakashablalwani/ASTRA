      ...
      try {
        ...
        if (userRes.data?.user?.role === "teacher") {
          try {
            ...
            const allSlots = ttRes.data.flatMap(
              (tt) => tt.parsedSchedule || []
            );
    ...
    <div className="container-fluid py-2">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="me-3">
                ...
                <p className="lead mb-0">
                  Welcome to CampusHive - Your unified hub for campus life
                </p>
              </div>
      ...
      <div className="mb-5">
        ...
        {testMsg && (
          <div
            className={`alert ${
              testMsg.startsWith("Failed") ? "alert-danger" : "alert-info"
            } mb-3`}
          >
            {testMsg}
          </div>
            ...
            >
              <div className="card-body p-4 text-white">
                ...
                <p className="mb-0 opacity-75">
                  Share about college & facilities
                </p>
              </div>
            </div>
          </Link>
      ...
      {isTeacher && (
        <div className="mt-5">
          ...
          {timetable.length === 0 ? (
            ...
            >
              <div className="card-body text-center py-5">
                <h4 style={{ color: "var(--nectar-text-secondary)" }}>
                    ...
                    <tbody>
                      {timetable.slice(0, 5).map((entry, idx) => (
                        <tr key={idx}>
                          ...
                          <td>
                            <strong>{entry.subject || "N/A"}</strong>
                          </td>
      ...
      {isLibrarian && (
        <div className="mt-5">
          <h3 className="mb-4">Library Quick Actions</h3>
          <div className="row g-4">
            <div className="col-md-6">
              <Link
                to="/library"
                state={{ openAddBook: true }}
