...
export default function StudySnap() {
  ...
  const handleUpload = async (e) => {
    ...
    if (seen.includes(signature)) {
      alert(
        "This looks like the same file you just uploaded. Duplicate prevented."
      );
      return;
    }
  ...
  return (
    <div className="container-fluid py-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h2 className="mb-1">📷 StudySnap</h2>
          <p className="text-muted mb-0">
            Share what you're studying right now
          </p>
        </div>
        <img
      ...
      <div className="row">
        {snaps.length === 0 ? (
            ...
            <div className="card shadow border-0" style={{ borderRadius: 16 }}>
              <div className="card-body text-center py-5">
                ...
                <p className="text-muted">
                  Share what you're studying and inspire others!
                </p>
              </div>
            </div>
          </div>
          ...
          snaps.map((snap, index) => {
            ...
            const isOwner =
              snapUserId === currentUser?._id || snapUserId === currentUser?.id;
              ...
              <div key={snap._id || index} className="col-md-6 col-lg-4 mb-4">
                ...
                >
                  {snap.imageUrl && (
                    <img
                      src={
                        snap.imageUrl.startsWith("http")
                          ? snap.imageUrl
                          : `${window.location.origin}${snap.imageUrl}`
                      }
                  ...
                  <div className="card-body">
                    ...
                    {snap.description && (
                      <p className="card-text mb-2">{snap.description}</p>
                    )}
              ...
              <form
                onSubmit={async (e) => {
                  ...
                  try {
                    ...
                    await api.put(`/studysnap/${editing._id}`, fd, {
                      headers: { "Content-Type": "multipart/form-data" },
                    });
                    setEditing(null);
                    fetchSnaps();
