...
export default function Timetables() {
  ...
  async function saveTimetable() {
    ...
    try {
      if (editingId) {
        await api.put(`/timetables/${editingId}`, {
          parsedSchedule,
          aiGenerated: false,
        });
      } else {
      ...
      <div className="row g-4">
        ...
        <div className="col-lg-5">
          <div className="card p-4 shadow-sm h-100 border-0">
            <h5 className="mb-3">Manual Timetable Editor</h5>
            <div className="row g-2 align-items-end">
              <div className="col-6">
                ...
                <select
                  ...
                  value={newSlot.day}
                  onChange={(e) =>
                    setNewSlot((s) => ({ ...s, day: e.target.value }))
                  }
                >
                  {daysOfWeek.map((d) => (
              ...
              <div className="col-6">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewSlot((s) => ({ ...s, subject: e.target.value }))
                  }
              ...
              <div className="col-6">
                ...
                <input
                  ...
                  value={newSlot.class}
                  onChange={(e) =>
                    setNewSlot((s) => ({ ...s, class: e.target.value }))
                  }
        ...
        <div className="col-lg-7">
          {parsedSchedule.length > 0 ? (
            <div className="card p-4 shadow-sm border-0">
              <h5 className="mb-4">Your Weekly Timetable</h5>

              <div className="table-responsive">
                <table className="table table-bordered table-hover">
                  <thead
                    style={{
                      background: "var(--nectar-primary)",
                      color: "#000",
                    }}
                  >
                    <tr>
            ...
            <div className="card p-5 shadow-sm text-center border-0">
              <div
                style={{ color: "var(--nectar-text-secondary)" }}
                className="mb-3"
              ></div>
              <h5 style={{ color: "var(--nectar-text-secondary)" }}>
                No Timetable Entries
              </h5>
              <p style={{ color: "var(--nectar-text-secondary)" }}>
                Use the Manual Timetable Editor to add your classes.
              </p>
            </div>
          )}
        </div>
      ...
      {list.length > 0 && (
        <div className="row mt-4">
          <div className="col-12">
            <div className="card p-4 shadow-sm border-0">
              <h5 className="mb-3">Saved Timetables</h5>
                  ...
                  <div key={t._id} className="col-md-6 col-lg-4">
                    <div className="card h-100 border-0 shadow-sm">
                      <div className="card-body d-flex flex-column">
                        <h6>
                          {t.aiGenerated ? "🤖 AI Generated" : "📄 Manual"}{" "}
                          Timetable
                        </h6>
                        <p
                          className="small"
                        ...
                        {t.parsedSchedule && t.parsedSchedule.length > 0 && (
                          <p className="small">
                            <span className="badge bg-info">
                              {t.parsedSchedule.length} time slots
                            </span>
                          </p>
                        )}
