...
export default function LostAndFound() {
  ...
  const handleAddItem = async (e) => {
    ...
    try {
      ...
      setNewItem({ title: '', description: '', category: 'electronics', location: '', date: '' });
      fetchItems();
    } catch (error) {
      ...
      <div className="card shadow-sm border-0 mb-4" style={{ borderRadius: 16 }}>
        <div className="card-body">
          <div className="btn-group w-100" role="group">
            ...
            <button 
              type="button" 
              className={`btn ${filter === 'lost' ? 'btn-danger' : 'btn-outline-danger'}`}
            ...
            <button 
              type="button" 
              className={`btn ${filter === 'found' ? 'btn-success' : 'btn-outline-success'}`}
        ...
        {filteredItems.length === 0 ? (
          ...
          filteredItems.map((item, index) => (
            <div key={index} className="col-md-6 col-lg-4 mb-4">
              <div className={`card shadow-sm border-0 h-100 ${item.resolved ? 'opacity-50' : ''}`} style={{ borderRadius: 16 }}>
                <div className="card-body">
            ...
            <div className="modal-content" style={{ borderRadius: 16 }}>
              ...
              <form onSubmit={handleAddItem}>
                ...
                <div className="modal-footer border-0">
                  ...
                  <button type="submit" className={`btn btn-${itemType === 'lost' ? 'danger' : 'success'}`}>
